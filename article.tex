...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.8\linewidth]{plots/reward}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/nash-0}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/nash-1}
  \end{minipage}
...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.8\linewidth]{plots/cutoff}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/solution-multiple-0}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/solution-multiple-1}
  \end{minipage}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.8\linewidth]{plots/cutoff-asymptotic}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.8\linewidth]{plots/efficiency}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/linear-dmax-shift}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/linear-lambda-shift}
  \end{minipage}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/regret_matching_methods_nashconv}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/regret_matching_methods_quasinashconv}
  \end{minipage}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/regret_matching_sizes_nashconv}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/regret_matching_sizes_quasinashconv}
  \end{minipage}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/nash-0.5}
  \end{minipage}
  \centering
  \begin{minipage}[t]{0.48\textwidth}
    \centering
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/nash-10}
  \end{minipage}
  \centering
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/nash-100}
  \end{minipage}
  \hfill
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/linear-dmax-no-shift}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includesvg[width=1.1\linewidth]{plots/linear-lambda-no-shift}
  \end{minipage}
\end{figure}
