...
\begin{figure}[htbp]
  ...
  \caption{Approximate and analytical solutions for $P=1, \rho=0, \tau=0$. Actions were discretized to a grid of $2^{12}$ with \texttt{shift~=~false}. The approximate solution was computed by $10^4$ iterations of regret matching.}
  \label{fig:rm-sol}  
\end{figure}
