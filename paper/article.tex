...
\begin{result}
    Players take more risks in environments of negative correlation. Negative correlation improves their payoff compared to an absence of correlation.

    Players take less risks in environments of positive correlation. The impact on performance is negative in efficient markets but can become positive in noisy markets.
\end{result}

We illustrate that behavior in Figure \ref{fig:result-corr}.
